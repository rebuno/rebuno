---
title: "Errors"
description: "The error hierarchy and how to handle it"
---
...
A `Client` call against an already-terminal execution, such as cancelling one
that has finished, throws `ConflictError`.
...
re-throw if you do. See [Dispatch and resume](/sdk/typescript/agents#dispatch-and-resume)
...
- `raiseForRefusal(err)` re-throws a Rebuno refusal a provider client wrapped in
  ...
  [LLM calls](/sdk/typescript/llm-calls#refused-calls).
