---
title: "Tools"
description: "Declare tools and control idempotency"
---
...
<Warning>
  ...
  [How it works](/sdk/typescript/internals#heartbeats-and-leases)). Offload
  CPU-bound work to a worker thread so the loop stays live.
</Warning>
