...
See [determinism and step ids](/sdk/typescript/internals#determinism-and-step-ids).
...
- `idempotency` mirrors [`defineTool`](/sdk/typescript/tools#idempotency): `safe_to_retry`
