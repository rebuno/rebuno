---
title: "Steps"
description: "Record local non-determinism so it replays identically"
---
...
replaying them. See [determinism and step ids](/sdk/python/internals#determinism-and-step-ids).
...
- `idempotency` mirrors [`@tool`](/sdk/python/tools#idempotency): `safe_to_retry`
