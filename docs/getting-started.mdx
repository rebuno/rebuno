...
If you use a coding agent, install the
[Rebuno skill](https://github.com/rebuno/rebuno/blob/main/skills/rebuno/SKILL.md)
for guidance on agent setup, SDK integration, and policies. Run this from your
project directory with Node.js and npm installed:

```bash
npx skills add rebuno/rebuno
```

Follow the prompts to choose your coding agent.
