...
func (k *KernelAPI) CreateExecution(ctx context.Context, agentID string, input json.RawMessage, options ...kernel.CreateExecutionOptions) (domain.Execution, error) {
	return k.Inner.CreateExecution(ctx, agentID, input, options...)
}
...
func (k *KernelAPI) FailExecution(ctx context.Context, execID uuid.UUID, lease domain.Lease, reason string) error {
	return k.Inner.FailExecution(ctx, execID, lease, reason)
}
